# ShinyApps.io Deployment - Minimal app.R
# This file wraps the Shiny app with deployment-specific configurations
...
flights_data <- read_csv("data/flights_with_weather.csv", show_col_types = FALSE)
...
ui <- fluidPage(
  ...
  div(class = "navbar-custom",
    ...
    div(
      HTML("<span style='color: #999; font-size: 12px;'>Running on saved data</span>")
    )
  ),
